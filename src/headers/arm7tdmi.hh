...
{
private:
    //ARM_MODE 32-bit ARM mode
    //THUMB_MODE 16-bit THUMB mode
    enum _mode{
        ARM_MODE,
        THUMB_MODE
    } mode;
    ...
    enum _registers{
        R0,R1,R2,R3,R4,R5,R6,R7,R8,R8_fiq,R9,R9_fiq,R10,R10_fiq,R11,R11_fiq,R12,R12_fiq,//General Purpose Registers
